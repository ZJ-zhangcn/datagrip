--每周五状态核对
select * from req where onlinedate between date'2025-08-11' and date'2025-08-15'
...
select (select codename
       ...
       a.no 需求号,
       a.name 需求名,
       (case when c.csrstartdate is null then '未测试'
 ...
 or (c.csrenddate is null and c.cspenddate<= date'2023-12-08' and a.state in('01','02','03','04','05','06','07','08'))--本周五
    or (c.cspenddate > date'2023-12-01' and c.cspstartdate <= date '2023-12-08')--上周五,本周五
   order by 状态,c.csopstartdate


select xkf,a.*,rowid from reqplan a where no='REQ-4082'
...
select a.*,rowid from req a where no='REQ-3919'
select a.*,rowid from reqwork a where no='REQ-3919'
select a.*,rowid from reqplan a where no='REQ-3919'
...
--上线需求
select count(*) from req a where ONLINEDATE between date '2024-05-01' and date '2024-05-31'

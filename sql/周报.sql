...
select xkf,a.* from reqplan a where no='REQ-4082';
...
select a.* from req a where no='REQ-3919';
select a.* from reqwork a where no='REQ-3919';
select a.* from reqplan a where no='REQ-3919';

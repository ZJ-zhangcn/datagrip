...
--账户
select a.* from lcinsureacc a where contno='2024121100002906';--baladate sumpay lastaccbala insuaccbala
select a.* from lcinsureaccclass a where contno='2024121100002906';--baladate sumpay lastaccbala insuaccbala
select a.* from lcinsureacctrace a where contno='2024121100002906' order by otherno,paydate,makedate ,maketime ;--删除续期实收产生的轨迹
...
select a.* from lcinsureaccfee a where contno='2024121100002906';--fee baladate
select a.* from lcinsureaccclassfee a where contno='2024121100002906';--baladate fee

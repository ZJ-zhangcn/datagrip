...
--拒保
select a.*,rowid from lccont a where uwflag='1' and appflag='0' and contno=prtno and grpcontno like '000000%' and prtno in (select CONTPRTNO from ybtnonrealtimepol/*非实时保单该表有数据*/)
--延期 

...
select agentcode,a.*,rowid from lccont a where contno='5000112600018707'

select a.*,rowid from laagent a where agentcode='JD000004'

select a.*,rowid from loprtmanager a where otherno='5000112600018707'

select a.*,rowid from es_doc_main a where docid='3613315100004459'

select a.*,rowid from ldtask a where taskclass='NewContDDUploadImageTask'

select a.*,rowid from lcinsured a where contno='5000112600005001'

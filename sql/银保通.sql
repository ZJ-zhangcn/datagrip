...
select a.*,rowid from ldtask a where taskdescribe like '%生存%'
select a.*,rowid from ldtask a where taskdescribe like '%满期%'

--
SELECT IDExpDate FROM ldperson where CustomerNo='1001733666' for update;

--需对账的保单
select contno,appntname,insuredname from ybtdat.cont where proposalprtno='2023110100000976' and state='2'
--dat
--投保单号查保单号
select contno,a.*,rowid from ybtdat.tranlog a where proposalprtno='5000118231031015'
--保单号查投保单号
select proposalprtno,a.*,rowid from ybtdat.tranlog a where contno='2023112300000116'
--校验agentcom在本系统中不存在，将状态改为n
select bankcode,agentcom,a.* from lacom a where bankcode like '133599935Q%' and state = 'N'
select state,a.*,rowid from lacom a where bankcode='15CN006'

--uat
--投保单号查保单号
select contno,a.*,rowid from xybt.tranlog a where proposalprtno='5000118231031015'
--保单号查投保单号
select proposalprtno,a.*,rowid from xybt.tranlog a where contno='2023110180801518'
--查询保全对账日期
select edorappdate,a.*,rowid from lpedoritem a where contno='2023112481400918'

--银保通保全确认插表
select * from es_doc_main where subtype='36524151' order by docid desc
select a.*,rowid from es_doc_main a where doccode='2023103000000216'
...
--上海银行保全对账所需数据
select contno,idtype,idno,appntname,rowid from lcappnt a where contno='2023102700000996'
...
select * from lpedoritem where edoracceptno='7402121100323709' and edorno='3623915100342094' and edortype='LG' for update;

--保全对账日期
select edorappdate,a.*,rowid from lpedoritem a where contno='2023103000000986'

select * from preybt.tranlog where rcode='0' and trancom='12' and funcflag='7005' and trandate='20231122' for update;

select payintv,a.*,rowid from lcpol a where contno='2023040100000116'
select salechnl,selltype,a.*,rowid from lccont a where contno='2023040100000116'
select a.*,rowid from lcappnt a where contno='2023040100000116'
select a.*,rowid from LCCONTDZYTPRINT a where contno='2023112300000116'
select a.*,rowid from lcepolicy a where contno='2023112300000116'

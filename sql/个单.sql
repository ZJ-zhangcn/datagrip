...
values ((select max(missionid)+1 from lwmission where length(missionid)=20 and REGEXP_LIKE(missionid, '^\d+$')), '1', '0000000003', '0000001095', '1', '5000118341250086', '2024-12-09', '11:12:58', '2024-12-09', '0', '860101', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '001', '001', '001', to_date('12-01-2026', 'dd-mm-yyyy'), '17:59:16', to_date('12-01-2026', 'dd-mm-yyyy'), '17:59:16', to_date('12-01-2026', 'dd-mm-yyyy'), '17:59:16', null, '', '', '', '', '', '', '', null, '', '860101', '00000000000000584470');

update lwmission set MISSIONID=(select max(missionid)+1 from lwmission where length(missionid)=20 and REGEXP_LIKE(missionid, '^\d+$')) where MISSIONPROP1='5000118341250086'
*/

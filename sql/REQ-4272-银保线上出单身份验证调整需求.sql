...
select a.* from lcidCardCheckInfo a where contno='2024091200000516' for update;
/*
...
select a.*,rowid from lcbnf a where contno='2024092500000386'

select appflag,a.*,rowid from lcpol a where contno='2024071700000326'

select a.*,rowid from lcidCardCheckInfo a where idno='210104198301100045'

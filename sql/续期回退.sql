...
select
       paytodate, sumprem, paytimes,
       a.*
from lcprem a where contno='2024052700000106';
...
select
       ...
       a.*
from lcinsureacc a where contno='2024052700000106';

select
       sumpay, insuaccbala, baladate,
       a.*
from lcinsureaccclass a where contno='2024052700000106';

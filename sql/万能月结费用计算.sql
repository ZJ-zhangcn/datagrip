...
--158.96736594
SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2025-11-02'-date'2025-11-01')*(183300.25-100000-5000+4.37)/*账户价值*/+round((power(1+0.03,1/12)-1)*12/365,8)*(date'2025-12-01'-date'2025-11-02')*(183300.25) from dual;
--158.96736594
SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2025-12-01'-date'2025-11-01')*(97804.16) FROM dual;--237.898838784
SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2025-12-01'-date'2025-11-02')*(0.46) from dual;
--0
SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2025-12-01'-date'2025-11-02')*(-10000.0) from dual;
---23.51


SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2025-11-01'-date'2025-10-01')*(195255.18) from dual;
--1.18
SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2025-12-01'-date'2025-11-01')*(100000.0) from dual;
--235.13
SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2025-12-01'-date'2025-11-01')*(-5000) from dual;
---11.76
SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2025-12-01'-date'2025-11-01')*(-4.37) from dual;
---0.01

SELECT 237.898838784+0.0010816072-23.5132+1.2162+243.24-12.162-0.010629588 FROM dual;

SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2026-01-01'-date'2025-12-01')*(9805.15) from dual;
--24.645048422
SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2026-01-01'-date'2025-12-12')*(10000) from dual;
--16.216
SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2026-01-01'-date'2025-12-12')*(-0.37) from dual;
---0.000599992
SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2026-01-01'-date'2025-12-12')*(-500) from dual;
---0.8108
SELECT round((power(1+0.03,1/12)-1)*12/365,8)*(date'2026-01-01'-date'2025-12-12')*(50) from dual;
--0.08108

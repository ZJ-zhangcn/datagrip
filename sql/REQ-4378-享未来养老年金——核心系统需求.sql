...
select a.prem / 1000 * b.endcv *
       ...
       greatest(0 - 0, 0)
  from lcpol a, cv_1031010 b, lcduty c
...
select a.prem / 1000 * b.endcv -
       (select nvl(sum(getmoney),0)
         ...
         where contno = a.contno
           and getdate between date '2025-08-28' and date '2025-10-01')
  from lcpol a, cv_1031010 b, lcduty c
 where insumode = c.insugetmode
   and a.insuredsex = b.gender
   and a.insuredappage = b.age
...
select a.prem / 1000 * b.endcv -
       (select nvl(sum(getmoney),0)
          from ljagetdraw
         where contno = a.contno
           and getdate between date '2026-08-28' and date '2027-10-01')
  from lcpol a, cv_1031010 b, lcduty c
 where insumode = c.insugetmode
   and a.insuredsex = b.gender
   and a.insuredappage = b.age
...
select a.prem / 1000 * b.endcv -
       (select nvl(sum(getmoney), 0)
          from ljagetdraw
         where contno = a.contno
           and getdate between date '2025-08-23' and date '2025-10-01')
  from lcpol a, cv_1031010 b, lcduty c
 where insumode = c.insugetmode
   and a.insuredsex = b.gender
   and a.insuredappage = b.age

--生存金自动转账反洗钱限额配置
select a.* from ldcode a where codetype='livinglimit'

--
select polno,riskcode,a.* from lcpol a where contno='2022102800000716'
...
--
select a.* from ldcode1 a where codetype = 'cuxbankerror' and codename like '%证件%'

--
select serialno,paycode,a.* from lyreturnfrombankb a where paycode='86000020450370000019'

select a.* from lcdrawautoacctrace a where contno='2024041800000206'

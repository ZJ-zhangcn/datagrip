...
select riskcode,appflag,a.* from lcpol a where contno='5001050200000043';--5000112600004665
...
select a.* from LCMedicalCluesBDY a where Contno = '5000118340620017' for update;
...
select a.* from ldcode1 a where codetype='freeduty' and code='ID0303' for update;

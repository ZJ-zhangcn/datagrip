select * from ljaget where otherno='2025072000000106';--delete
...
select * from ljabonusget where contno='2025072000000106' order by BONUSYEAR;--delete
select * from lcinsureacctrace where contno='2025072000000106' order by paydate;--delete
...
--¹ºÂò¼õ¶î½»Çå
select a.* from lcduty a where contno='2025072000000106';--amnt
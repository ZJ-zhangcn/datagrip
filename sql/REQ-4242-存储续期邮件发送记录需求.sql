...
select a.* from ljspay a where otherno='2023010100004886';
select a.* from ljspayperson a where contno='2024090200000406';
select email,a.* from lcaddress a where customerno in (select appntno from lcappnt where contno='2024082000000176')--zhangjin05@sinosoft.com.cn

...
--企查查配置单证
select a.*,rowid from ldcode a where codetype='QCCCheckInfo' and code='32069151';
select a.*,rowid from ldcode a where codetype='BusinessRegStatus' order by code;

--
select EnterpriseCheck,a.*,rowid from LCGrpAppnt a where prtno=''

--交易日志表
select a.*,rowid from LCQccRunlog a where BUSINESSNO='5005190141017010';
...
--受益人表
select * from LCBenifit a where BUSINESSNO='5005190141017010' for update;
...
--股权穿透结果列表
select a.*,rowid from LCBnfOwner a where BUSINESSNO='5005190140701013';
--企业受益股东穿透详情
select a.*,rowid from LCBreakThrough a where BUSINESSNO='5005190140701013';
--高级管理人员列表
select a.*,rowid from LCSmanent a where BUSINESSNO='5005190140701013';
--有效控制或实际影响的组织/个人列表
select a.*,rowid from LCEffectiveol a where BUSINESSNO='5005190140701013';

/*
update lccont set getpoldate=signdate,customgetpoldate=signdate where prtno='5000118350212024'
update lccont set getpoldate=signdate,customgetpoldate=signdate where contno in ('2025010900000176','','')
...
--险种配置表
select STARTDATE,enddate,a.* from lmriskapp a where riskcode='1013004'
select STARTDATE,a.* from lmriskapp a where riskname like '%浦江财富二号终%'
...
--lcpol
select contno from lcpol where prtno='5000118350212024'
...
select a.* from sms_dispatch_list a where otherno='5000118350212024' and SENDTARGET='17511189991'
...
select a.* from lmriskcheckrule a where riskcode='1036001' and checklocal='FHWB' order by checksort 
...
--
select a.* from ljspay a where otherno='2025031900000386';
/*
update ljspay set payform='Y' where otherno='2025012300000426';
*/
select a.* from ljspayperson a where contno='2024120500000456'
...
select a.* from ljapayperson a where contno='2024123000000376' order by paycount
--
...
select sendflag,a.* from ljaget a where otherno='2025010900000176' order by shoulddate desc;
select a.* from ljagetdraw a where contno in ('2025011600000486','','','') order by getdate desc;

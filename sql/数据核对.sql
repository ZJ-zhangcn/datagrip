...
update lccont set getpoldate=signdate,customgetpoldate=signdate where contno in ('2025072300000226','','')
...
--险种支持的销售渠道
select salechnl,a.* from ldriskrule a where riskcode in ('1033029','') order by a.riskcode,a.SALECHNL;
--支持不同保单生存金转入万能账户险种
select * from ldcode1 where codetype='transferCont';
--lcpol
select contno from lcpol where prtno='5000118350721046'
...
select contno,
  ...
  from lcget a
 where contno = '2025073000000216';

select a.* from lcget a where contno = '2025072300000316';
...
select idstdate,idexpdate,a.* from lcinsured a where contno='2025072400000696'
...
select a.* from sms_dispatch_list a where otherno='5000111000019092'
...
select a.* from lmriskcheckrule a where riskcode='1103005' and checklocal='FHWB' order by CHECKLOCAL,checksort
...
/*
update ljspay set payform='Y' where otherno='2025073100000186'
*/
...
--
select a.* from ljsget a where otherno='2025072400000696' order by getdate desc;
select a.* from ljsgetdraw a where contno='2025072400000696' order by getdate ;
...
select sendflag,PRTNOTESTATE,a.* from ljaget a where otherno='2025072400000696' order by shoulddate;
select a.* from ljagetdraw a where contno in ('2025072400000696','','','') order by getdate;
...
select a.* from lobonuspol a where contno='2025063000000186' order by FISCALYEAR;
...
select a.* from lcinsureacctrace a where contno='2025072300000316' order by paydate,makedate,MAKETIME;
select a.* from lcinsureacctrace a where contno='2025072300000316' order by otherno,paydate,makedate,MAKETIME;
...
/*
update lcinsureacctrace set makedate=paydate,modifydate=paydate where contno='2025070200000726' and moneytype != 'CXJJ';
update lcinsureacctrace set makedate=paydate+1,modifydate=paydate+1 where contno='2025070200000726' and moneytype = 'CXJJ'
*/
select a.* from LCINSUREACCFEE a where contno='2025072300000316'
select a.* from lcinsureaccfeetrace a where contno='2025072300000316' order by paydate,makedate,MAKETIME;
select a.* from LCINSUREACCCLASSFEE a where contno='2025072300000316'
/*
update lcinsureaccfeetrace set makedate=paydate,modifydate=paydate where contno='2025070200000726'
*/

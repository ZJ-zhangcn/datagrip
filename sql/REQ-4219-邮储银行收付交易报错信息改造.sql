...
select a.*,rowid from lyreturnfrombankb a where polno='2024072900000276'

select a.*,rowid from loprtmanager a where otherno='2024072900000276'

select PRTNOTESTATE,a.*,rowid from ljspay a where otherno='2024072900000276'
